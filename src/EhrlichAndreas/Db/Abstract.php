 ...
 */
class EhrlichAndreas_Db_Abstract
{

    /**
     * Use the PROFILER constant in the config of a EhrlichAndreas_Db_Adapter.
     */
    const PROFILER = 'profiler';

    /**
     * Use the CASE_FOLDING constant in the config of a EhrlichAndreas_Db_Adapter.
     */
    const CASE_FOLDING = 'caseFolding';

    /**
     * Use the FETCH_MODE constant in the config of a EhrlichAndreas_Db_Adapter.
     */
    const FETCH_MODE = 'fetchMode';

    /**
     * Use the AUTO_QUOTE_IDENTIFIERS constant in the config of a
     * EhrlichAndreas_Db_Adapter.
     */
    const AUTO_QUOTE_IDENTIFIERS = 'autoQuoteIdentifiers';

    /**
     * Use the ALLOW_SERIALIZATION constant in the config of a
     * EhrlichAndreas_Db_Adapter.
     */
