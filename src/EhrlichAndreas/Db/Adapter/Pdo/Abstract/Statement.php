 ...
 * are re-thrown as EhrlichAndreas_Db_Exception.
 *
 * @author Ehrlich, Andreas <ehrlich.andreas@googlemail.com>
 */
class EhrlichAndreas_Db_Adapter_Pdo_Abstract_Statement extends EhrlichAndreas_Db_Statement implements IteratorAggregate
{
     ...
     * @var int
     */
    protected $_fetchMode = EhrlichAndreas_Pdo_Abstract::FETCH_ASSOC;
    ...
    public function _execute (array $params = null)
    {
        ...
        {
            throw new EhrlichAndreas_Db_Exception($e->getMessage(), (int) $e->getCode(), $e);
        }
    }
    ...
    public function fetchAll ($style = null, $col = null)
    {
        ...
        try
        {
            if ($style == EhrlichAndreas_Pdo_Abstract::FETCH_COLUMN)
            {
                if ($col === null)
                {
                    $col = 0;
