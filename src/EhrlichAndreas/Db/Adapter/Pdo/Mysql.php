 ...
 */
class EhrlichAndreas_Db_Adapter_Pdo_Mysql extends EhrlichAndreas_Db_Adapter_Pdo_Abstract
{
     ...
     * EhrlichAndreas_Db::INT_TYPE, EhrlichAndreas_Db::BIGINT_TYPE, or EhrlichAndreas_Db::FLOAT_TYPE.
     *
     * Values are:
     * 0 = 32-bit integer
     * 1 = 64-bit integer
    ...
    (
        ...
        'INT'                                   => EhrlichAndreas_Db_Abstract::INT_TYPE,
        'INTEGER'                               => EhrlichAndreas_Db_Abstract::INT_TYPE,
        'MEDIUMINT'                             => EhrlichAndreas_Db_Abstract::INT_TYPE,
        'SMALLINT'                              => EhrlichAndreas_Db_Abstract::INT_TYPE,
        'TINYINT'                               => EhrlichAndreas_Db_Abstract::INT_TYPE,
        'BIGINT'                                => EhrlichAndreas_Db_Abstract::BIGINT_TYPE,
        'SERIAL'                                => EhrlichAndreas_Db_Abstract::BIGINT_TYPE,
        'DEC'                                   => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'DECIMAL'                               => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'DOUBLE'                                => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'DOUBLE PRECISION'                      => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'FIXED'                                 => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'FLOAT'                                 => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
    );

    /**
     * Override _dsn() and ensure that charset is incorporated in mysql
     * @see EhrlichAndreas_Db_Adapter_Pdo_Abstract::_dsn()
     */
    ...
    public function describeTable($tableName, $schemaName = null)
    {
        ...
        $result = $stmt->fetchAll(EhrlichAndreas_Db_Abstract::FETCH_NUM);
     ...
     */
     public function limit($sql, $count, $offset = 0)
     {
        ...
        if ($count <= 0)
        {
            ...
            throw new EhrlichAndreas_Db_Exception("LIMIT argument count=$count is not valid");
        }
        ...
        {
            /** @see EhrlichAndreas_Db_Exception */
            throw new EhrlichAndreas_Db_Exception("LIMIT argument offset=$offset is not valid");
        }
