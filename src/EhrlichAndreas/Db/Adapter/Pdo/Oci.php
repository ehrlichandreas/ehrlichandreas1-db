 ...
 * @subpackage Adapter
 */
class EhrlichAndreas_Db_Adapter_Pdo_Oci extends EhrlichAndreas_Db_Adapter_Pdo_Abstract
{
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'EhrlichAndreas_Db_Adapter_Pdo_Oci_Statement';
    ...
    (
        ...
        'BINARY_DOUBLE'                         => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'BINARY_FLOAT'                          => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
        'NUMBER'                                => EhrlichAndreas_Db_Abstract::FLOAT_TYPE,
    );
     ...
     * EhrlichAndreas_Db_Adapter_Abstract class.
     *
     ...
     *
     * @param string|array|EhrlichAndreas_Db_Expr|Zend_Db_Expr $ident The identifier or expression.
    ...
    public function describeTable($tableName, $schemaName = null)
    {
         ...
         */
        $result = $stmt->fetchAll(EhrlichAndreas_Db::FETCH_NUM);
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        $limit_sql = "SELECT z2.*
            FROM (
                SELECT z1.*, ROWNUM AS \"ehrlichandreas_db_rownum\"
                FROM (
                    " . $sql . "
                ) z1
            ) z2
            WHERE z2.\"ehrlichandreas_db_rownum\" BETWEEN " . ($offset+1) . " AND " . ($offset+$count);
